...
PRODUCT_COPY_FILES += \
    ...
    vendor/fortune/config/permissions/default_permissions_com.android.wallpaper.xml:$(TARGET_COPY_OUT_SYSTEM_EXT)/etc/default-permissions/default_permissions_com.android.wallpaper.xml
