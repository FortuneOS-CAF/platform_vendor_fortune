...
def list_default_repos(is_system):
    ...
    if is_system:
        with open(
            "{0}/.repo/manifests/clo/system.xml".format(WORKING_DIR)
        ) as system_manifest:
        ...
        with open(
            "{0}/.repo/manifests/clo/vendor.xml".format(WORKING_DIR)
        ) as vendor_manifest:
