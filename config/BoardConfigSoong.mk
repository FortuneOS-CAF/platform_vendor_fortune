...
$(if $($(1)), \
  $(eval SOONG_CONFIG_fortuneGestureVars += $(vn)) \
  $(eval SOONG_CONFIG_fortuneGestureVars_$(vn) := $(patsubst "%",%,$($(1)))) \
)
endef

SOONG_CONFIG_NAMESPACES += fortuneGestureVars
SOONG_CONFIG_fortuneGestureVars :=
GESTURE_SOONG_VARS := \
